...
<div class="d-flex gap-2 justify-content-center py-5">
  <span class="badge bg-primary-subtle text-primary-emphasis rounded-0">히트</span>
  <span class="badge bg-secondary-subtle text-secondary-emphasis rounded-0">수정</span>
  <span class="badge bg-success-subtle text-success-emphasis rounded-0">성공</span>
  <span class="badge bg-danger-subtle text-danger-emphasis rounded-0">위험</span>
  <span class="badge bg-warning-subtle text-warning-emphasis rounded-0">경고</span>
  <span class="badge bg-info-subtle text-info-emphasis rounded-0">정보</span>
  <span class="badge bg-light-subtle text-light-emphasis rounded-0">사랑</span>
  <span class="badge bg-dark-subtle text-dark-emphasis rounded-0">희망</span>
</div>
...
<div class="d-flex gap-2 justify-content-center pt-5 pb-3">
