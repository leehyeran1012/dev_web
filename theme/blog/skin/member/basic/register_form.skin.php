...
<div class="register container mb-5 pb-5">
...
gif, jpg, png파일만 가능하며 용량 <?php echo number_format($config['cf_member_icon_size']) ?>바이트 이하만 등록됩니다.</span>
	...
	<div class="btn_confirm">
	    <a href="<?php echo G5_URL ?>" class="btn btn-outline-secondary">취소</a>
	    <button type="submit" id="btn_submit" class="btn btn-outline-secondary" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
	</div>
	</form>
</div>
<script>
