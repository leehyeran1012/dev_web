...
<div class="card">
	...
	<div class="card-body">
		<div class="btn-group w-100">
			...
			<a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn btn-outline-primary btn-sm">결과보기</a>
			<?php if ($is_admin == "super") {  ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-cog fa-spin fa-fw"></i></a><?php }  ?>
		</div>
	</div>
</div>
</form>
