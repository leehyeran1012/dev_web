...
?>
		...
		<div class="container p-0 mt-3">
			  <div class="row">
				<div class="col text-start fs-4"><?php echo $g5['title'] ?></div>
				<div class="col text-end"><span class="btn btn-info btn-sm">전체 <?php echo $nf_total_po_cnt ?>표</span></div>
			  </div>
		</div>
