...
<section id="bo_w">
	...
	<!--아이콘-->
	<?php
		$timeline_icon = array("fa-check","fa-home","fa-pencil","fa-power-off","fa-signal");

	?>
	<div class="write_div">
		<span class="sound_only">아이콘</span>
		<?php for($i = 0;$i < count($timeline_icon);$i += 1) { ?>
		<input type="radio" name="wr_1" value="<?php echo $timeline_icon[$i]?>" id="<?php echo $timeline_icon[$i]?>" <?php echo $write['wr_1'] == $timeline_icon[$i]?" checked":""?>>&nbsp; <label for="<?php echo $timeline_icon[$i]?>" > <i class="fa <?php echo $timeline_icon[$i]?>"></i> </label>&nbsp;
		<?php } ?>

	</div>

	<div class="write_div ">
		<select name="wr_2" class="frm_input">
			<option value="">년</option>
			<?php for($i = 1970;$i < date("Y");$i += 1) { ?>
			<option value="<?php echo $i?>"><?php echo $i?></option>
			<?php } ?>

		</select>

		<select name="wr_3" class="frm_input">
