...
<div class="container p-0">
	...
	<?php if ($is_category) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">분류</label>
	...
	<?php if ($is_name) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">이름</label>
		<div class="col-sm-12 col-md-10">
	...
	<?php if ($is_password) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">비밀번호</label>
		<div class="col-sm-12 col-md-10">
	...
	<!-- <?php if ($is_email) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">이메일</label>
		<div class="col-sm-12 col-md-10">
	...
	<?php if ($is_homepage) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">홈페이지</label>
		<div class="col-sm-12 col-md-10">
	...
	<?php if ($option) { ?>
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">옵션</label>
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">제목</label>
		<div class="col-sm-12 col-md-10">
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block"><?= $board['bo_'.$i.'_subj']; ?></label>
		<div class="col-sm-12 col-md-10">
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">내용</label>
		<div class="wr_content col-sm-12 col-md-10 <?= $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">링크<?= $i?></label>
		<div class="col-sm-12 col-md-10">
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">파일<?= $i+1 ?></label>
		<div class="col-sm-12 col-md-10">
			<div class="input-group">
	...
	<div class="row mb-2">
		<label class="col-sm-12 col-md-2 col-form-label d-none d-md-block">보안</label>
		<div class="col-sm-12 col-md-10">
			<?= $captcha_html ?>
		</div>
	</div>
