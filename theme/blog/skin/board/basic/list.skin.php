		...
		<tbody>
			...
			<tr class="<?php if($list[$i]['is_notice']) echo "table-primary"; ?>">
				...
				<td class="text-truncate text-start py-3">
					...
					<?php } ?>
					<?php
                    if ($list[$i]['icon_new']) echo "<span class='badge bg-danger fs-9'>N<span class='sound_only'>새글</span></span>";
			//		if(isset($list[$i]['icon_hot'])) echo ' <span class="badge bg-danger fs-9"><i class="fa fa-fire"></i></span>';
			//		if(isset($list[$i]['icon_file'])) echo ' <span class="text-muted fs-9"><i class="fa fa-download"></i></span>';
			//		if(isset($list[$i]['icon_link'])) echo ' <span class="text-muted fs-9"><i class="fa fa-link"></i></span>';
					?>
					<!-- 모바일 -->
					<ul class="list-inline small text-muted mt-1 mb-0 d-md-none">
						<li class="list-inline-item">
							...
							<div class="dropdown d-inline">
								<a href="#" data-bs-toggle="dropdown" class="link-body-emphasis"><?= get_text($list[$i]['wr_name']); ?></a>
								<?= $mb_info['menu'] ?>
							</div>
						</li>
				...
				<td class="d-none d-md-table-cell small"><?= number_format($list[$i]['wr_hit']) ?></td>
				...
				<td class="d-none d-md-table-cell small"><?= $list[$i]['datetime2'] ?></td>
			</tr>
			<?php } ?>
