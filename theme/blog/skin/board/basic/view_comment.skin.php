			...
			<div class="comm-body w-100">
				<ul class="comm-name list-inline">
					<li class="list-inline-item">
						...
						<?php if ($is_ip_view) { ?>
						<small class="text-dark-emphasis">(<?= $list[$i]['ip']; ?>)</small>
						<?php } ?>
						<?= $mb_info['menu'] ?>
					</li>
					<li class="list-inline-item">
				...
				<ul class="list-inline small pt-1 mb-2">
					<li class="list-inline-item text-dark"><i class="fa fa-clock-o"></i> <?= $list[$i]['datetime']; ?></li>

					<?php if ($list[$i]['is_reply']) { ?><li class="list-inline-item text-dark"><i class="fa fa-commenting-o"></i> <a href="<?= $c_reply_href;  ?>" onclick="comment_box('<?= $comment_id ?>', 'c'); return false;" class="text-dark">댓글</a></li><?php } ?>
					<?php if ($list[$i]['is_edit']) { ?><li class="list-inline-item"><i class="fa fa-pencil-square"></i> <a href="<?= $c_edit_href;  ?>" onclick="comment_box('<?= $comment_id ?>', 'cu'); return false;" class="text-dark-emphasis">수정</a></li><?php } ?>
					<?php if ($list[$i]['is_del'])  { ?><li class="list-inline-item"><i class="fa fa-trash-o"></i> <a href="<?= $list[$i]['del_link'];  ?>" onclick="return comment_delete();" class="text-dark-emphasis">삭제</a></li><?php } ?>
				</ul>
