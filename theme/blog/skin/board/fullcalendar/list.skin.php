...
<div id='calendar'></div>
<p class="mt-2 small">※ 일정입력은 마우스로 클릭하거나 끌어서 입력. 기간별 일정은 <strong>(월)</strong> 화면에서, 시간별 일정은 <strong>(주)</strong> 화면에서 입력</p>
<p class="small">※ 마우스로 이동, 기간 수정 가능함, 막대를 이동, 줄이거나 늘이면 수정됨.</p>
  ...
  <div class="modal-dialog modal-lg" style="max-width:580px">
	...
	<form action="#" name="eventform" id="eventform">
      ...
      <div class="modal-header bg-light py-2">
        <h5 class="modal-title text-start text-dark" id="eventModalLabel"><i class="bi bi-calendar-plus-fill"></i> 일정등록</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body p-2 py-3">
		<div class="container">
			<div class="row">
		<?php if($accessCode == 1 && $board['bo_write_level'] == 1) { ?>
