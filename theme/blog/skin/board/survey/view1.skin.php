...
<div class="container-fluid">
	...
	<h3 class="text-center mb-5"><?= $board['bo_subject'] ?></h3>
	...
	<div class="d-flex flex-sm-row flex-column justify-content-sm-between mb-4">
		...
		<div class="d-flex justify-content-center">
			<div class="btn-group xs-100">
			<a href="<?=G5_BBS_URL?>/write.php?bo_table=<?=$bo_table?>_result&k_num=<?=$view['wr_id']?>" class="btn btn-success">참여하기</a>
				<a href="<?= $list_href ?>" class="btn btn-secondary"><i class="fa fa-list"></i> 목록</a>
