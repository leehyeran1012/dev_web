...
<div class="container p-0">
	...
	<div class="row mb-2">
		<label class="col-sm-2 col-form-label"><?= $board['bo_'.$i.'_subj']; ?></label>
		<div class="col-sm-10">
	...
	<div class="row mb-2">
		...
		<div class="wr_content col-sm-10 <?= $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
	...
	<div class="row mb-2">
		<label class="col-sm-2 col-form-label">링크<?= $i?></label>
		<div class="col-sm-10">
	...
	<div class="row mb-2">
		<label class="col-sm-2 col-form-label">파일<?= $i+1 ?></label>
		<div class="col-sm-10">
			<div class="input-group">
