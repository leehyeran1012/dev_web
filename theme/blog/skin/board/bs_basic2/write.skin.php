...
<div class="container p-0">
	...
	<div class="border rounded py-2 ps-4 bg-light mb-4"><h2 class="fs-5 fw-bold"><?= $board['bo_subject'] ?> 글쓰기</h2></div>
	...
	<?php if ($option) { ?>
	<div class="row mb-2">
		<label class="col-sm-1 col-form-label">옵션</label>
	...
	<div class="row mb-2">
		<label class="col-sm-1 col-form-label">링크<?= $i?></label>
		<div class="col-sm-11">
			<input class="form-control" type="url" name="wr_link<?= $i ?>" value="<?php if($w=="u"){echo$write['wr_link'.$i];} ?>" id="wr_link<?= $i ?>" placeholder="링크주소를 입력해주세요.">
		</div>
	</div>
	<?php } ?>
	...
	<div class="row mb-2">
		<label class="col-sm-1 col-form-label">파일<?= $i+1 ?></label>
		<div class="col-sm-11">
			<div class="input-group">
