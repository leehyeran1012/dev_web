...
<?php } ?>
<style type="text/css">
	.dropstart:hover .dropdown-menu {display: block; margin-top: 0;}
</style>
<div class="container p-0">

	<div class="border rounded py-2 ps-4 bg-light mb-5"><h2 class="fs-5 fw-bold"><?= $board['bo_subject'] ?></h2></div>

	<h3 class="fs-3 fw-bold mb-3"><?= cut_str(get_text($view['wr_subject']), 70); ?></h3><hr>
	...
	<div class="d-flex mb-5 border-bottom pb-2">
		...
		<div class="ms-auto">
			<div class="btn-group dropstart">
			  <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-gear"></i></button>
